...
const SESSION_SPEAKERS = [
    { id: 1, name: 'Adea Natchiah-Blay', role: 'Speaker', image: adea, flag: 'GH', linkedin: 'https://www.linkedin.com/in/adea-natchiah-blay/', day: 3, bio: "Adea is a Software Quality Engineer Lead with eight years of experience in the banking sector. She combines her IT Law studies to explore the intersection of regulation and software development." },
    { id: 2, name: 'Dennis Nyabuti', role: 'Speaker', image: sessionSpeaker2, flag: 'RW', linkedin: 'https://www.linkedin.com/in/dmnyabuti', day: 3, bio: "Dennis is the CEO and Co-founder of BuniAI and an Engineering Manager at One Acre Fund. He is dedicated to using technology to solve real-world problems and bridging the digital divide by empowering the next generation of African founders." },
    { id: 3, name: 'Doho Séverin', role: 'Speaker', image: sessionSpeaker11, flag: 'CM', linkedin: 'https://www.linkedin.com/in/severin-doho/', day: 2, bio: "Séverin is a Senior QA Engineer with over 8 years of experience in manual testing, automation, and CI/CD. He is passionate about helping QA Engineers become active contributors to product quality and business confidence." },
    { id: 4, name: 'Christianah Ajala', role: 'Speaker', image: sessionSpeaker3, flag: 'GB', linkedin: 'https://www.linkedin.com/in/ajala-christianah-eniola', day: 1, bio: "Christianah is a Senior Quality Assurance Engineer with experience across banking, health tech, and civil service. She holds an MSc in Applied AI and is a passionate community builder and mentor." },
    { id: 5, name: 'Nikhil Bhandari', role: 'Speaker', image: sessionSpeaker4, flag: 'IN', linkedin: 'https://www.linkedin.com/in/nikhilbhandari/', day: 1, bio: "Nikhil is a Quality Engineering leader with nearly two decades of experience. An expert in scalable frameworks and a prominent advocate for open-source solutions, he is passionate about modernizing testing lifecycles." },
    { id: 6, name: 'Omowumi Oladele', role: 'Speaker', image: sessionSpeaker5, flag: 'NG', linkedin: 'https://www.linkedin.com/in/omowumi-oladele/', day: 1, bio: "Omowumi is a Senior Product Manager and AI Product Leader building intelligent systems across Africa, Europe, and North America. She is a multi-award-winning leader championing responsible, human-centered AI." },
    { id: 7, name: 'Samuel Afolabi', role: 'Speaker', image: sessionSpeaker6, flag: 'NG', linkedin: 'https://www.linkedin.com/in/lordsamafolabi/', day: 2, bio: "Samuel is a cybersecurity multipotentialite with experience across Fintech, Healthcare, and E-commerce. He was recognized as one of 2025’s 'Trailblazing Cybersecurity Leaders to Watch'." },
    { id: 8, name: 'Shashank Parmar', role: 'Speaker', image: sessionSpeaker7, flag: 'IN', linkedin: 'https://www.linkedin.com/in/dearshashank/', day: 1, bio: "Shashank is an automation specialist focusing on the intersection of AI and Software Testing. He emphasizes creating smart, self-evolving testing systems using tools like n8n and AI agents." },
    { id: 9, name: 'Mary Onuorah', role: 'Speaker', image: sessionSpeaker8, flag: 'NG', linkedin: 'https://www.linkedin.com/in/onuorahmary', day: 2, bio: "Mary is a Product Quality Engineer at Moniepoint, architecting quality systems for high-stakes platforms. She founded The Tech Eagle Community and trains software testers in test automation." },
    { id: 10, name: 'Matachi Ononuju', role: 'Speaker', image: sessionSpeaker9, flag: 'NG', linkedin: 'https://www.linkedin.com/in/matachi-ononuju/', day: 2, bio: "Known as MadamQA, Matachi is a QA Engineer with expertise in fintech, trading, and gaming. She is passionate about community building and sharing practical insights within the African tech ecosystem." },
    { id: 11, name: 'Sally Sedky', role: 'Speaker', image: sessionSpeaker10, flag: 'EG', linkedin: 'https://www.linkedin.com/in/sally-sedky-sdet-associate-manager/', day: 1, bio: "Sally is a QA & Test Associate Manager at Vodafone with over a decade of experience. She specializes in building resilient test automation frameworks and integrating Generative AI into testing." },
    { id: 12, name: 'Udeme Jalekun', role: 'Speaker', image: sessionSpeaker12, flag: 'GB', linkedin: 'http://www.linkedin.com/in/udeme-jalekun', day: 3, bio: "Udeme is a QA Engineer at Raenest, driving quality initiatives for major digital platforms. She designs large-scale training programs and champions quality as a business advantage." },
    { id: 13, name: 'Ikenna Okafor', role: 'Speaker', image: sessionSpeaker13, flag: 'GH', linkedin: 'https://linkedin.com/in/ikennasylvestreokafor', day: 3, bio: "Ikenna is a software QA professional and founder of TestAfriq, a non-profit empowering software testers. He is committed to advancing software quality standards and building globally competitive African tech talent." },
    { id: 14, name: 'Adedolapo Oguntayo-Williams', role: 'Speaker', image: sessionSpeaker14, flag: 'NG', linkedin: 'https://www.linkedin.com/in/adedolapo-oguntayo/', day: 2, bio: "Adedolapo is a Cybersecurity & Compliance Product Manager and Founder of LearnArk Academy. An ADPList Top 1% global mentor, she brings a blend of technical depth and human-centered thinking to her work." },
